|  **Coin** | **Website** | **Announce** | **Market** | **Wallet** | **Explorer** | **Algo** | **Script** | **Git** |
|  ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ |
|  AEON | [Aeon](http://www.aeon.cash/) | [BTCTalk](https://bitcointalk.org/index.php?topic=641696.0) | Link | [Link](https://www.aeon.cash/#downloads) | Link | cn_lite_v7 | [GitHub](https://github.com/aeugenegray/xmr-stak-aeon.git) |  |
